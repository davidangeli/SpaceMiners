...
public class Game implements Callable<Optional<int[][]>> {
     ...
     */
    public Game(Properties props, int id, String name, int rank, boolean closed, int minpl, int maxpl, int port, Player createdby) {
        setProperties(props);
     ...
     */
    @Override
    public Optional<int[][]> call() throws IOException, InterruptedException {
    ...
    private void setProperties(Properties props){
        UPDATEMSC=Integer.parseInt(props.getProperty("game_updatemsc"));
